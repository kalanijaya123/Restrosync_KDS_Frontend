            ...
            <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
                <header className="py-4">
                    <div className="max-w-3xl mx-auto px-6 flex items-center gap-4">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-white">DRINKS BAR</h1>
                    </div>
                </header>
                    ...
                    <div className="max-w-3xl mx-auto">
                        <div className="space-y-4 overflow-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
                            {combined.map((order: any) => (
                                <div key={order.id} className={`rounded-xl p-4 shadow-md border-2 ${order.status === 'pending' ? 'bg-red-50 dark:bg-red-900/20 border-red-300 dark:border-red-700' :
                                    order.status === 'preparing' ? 'bg-cyan-50 dark:bg-cyan-900/20 border-cyan-300 dark:border-cyan-700' :
